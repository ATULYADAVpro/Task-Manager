...
export const BUTTON_CLASSES =
    "w-full bg-gradient-to-r cursor-pointer from-blue-500 to-indigo-600 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
export const SECTION_WRAPPER = "bg-white rounded-xl shadow-sm border border-indigo-100 p-6"
...
export const SIDEBAR_CLASSES = {
    desktop: "hidden md:flex flex-col fixed h-full w-20 lg:w-64 bg-white/90 backdrop-blur-sm border-r border-indigo-100 shadow-sm z-20 transition-all duration-300",
    mobileButton: "absolute md:hidden top-25 left-5 z-50 bg-indigo-600 text-white p-2 rounded-full shadow-lg hover:bg-indigo-700 transition",
    mobileDrawerBackdrop: "fixed inset-0 bg-black/40 backdrop-blur-sm",
    mobileDrawer: "absolute top-0 left-0 w-64 h-full bg-white/90 backdrop-blur-md border-r border-indigo-100 shadow-lg z-50 p-4 flex flex-col space-y-6",
}

export const LINK_CLASSES = {
    base: "group flex items-center px-4 py-3 rounded-xl transition-all duration-300",
    active: "bg-gradient-to-r from-indigo-50 to-blue-50 border-l-4 border-indigo-500 text-indigo-700 font-medium shadow-sm",
...
export const TIP_CARD = {
    container: "bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-4 border border-indigo-100",
...
export const BUTTONCLASSES =
    "w-full bg-gradient-to-r from-blue-500 cursor-pointer to-indigo-600 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
// Stats definitions
export const STATS = [
    { key: "total", label: "Total Tasks", icon: HomeIcon, iconColor: "bg-indigo-100 text-indigo-600", valueKey: "total", gradient: true },
...
export const EMPTY_STATE = {
    wrapper: "p-6 bg-white rounded-xl shadow-sm border border-indigo-100 text-center",
    iconWrapper: "w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4",
...
export const SELECT_CLASSES = "px-3 py-2 border border-indigo-100 rounded-lg focus:ring-2 focus:ring-indigo-500 md:hidden text-sm"
export const TABS_WRAPPER = "hidden md:flex space-x-1 bg-indigo-50 p-1 rounded-lg"
...
export const CT_CLASSES = {
    ...
    sortBox: "flex items-center justify-between bg-white p-2 md:p-3 rounded-xl shadow-sm border border-indigo-100 w-full md:w-auto",
    filterLabel: "flex items-center gap-2 text-gray-700 font-medium",
    select: "px-2 py-1 md:px-3 md:py-2 border border-indigo-100 rounded-lg focus:ring-2 focus:ring-indigo-500 md:hidden text-xs md:text-sm",
    ...
    emptyState: "p-4 md:p-8 bg-white rounded-xl shadow-sm border border-indigo-100 text-center",
    emptyIconWrapper: "w-12 h-12 md:w-16 md:h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4",
...
export const layoutClasses = {
    ...
    sortBox: "flex items-center justify-between bg-white p-3 rounded-xl shadow-sm border border-indigo-100 w-full md:w-auto",
    select: "px-3 py-2 border border-indigo-100 rounded-lg focus:ring-2 focus:ring-indigo-500 md:hidden text-sm",
    ...
    addBox: "hidden md:block p-5 border-2 border-dashed border-indigo-200 rounded-xl hover:border-indigo-400 transition-colors cursor-pointer mb-6 bg-indigo-50/50 group",
    emptyState: "p-8 bg-white rounded-xl shadow-sm border border-indigo-100 text-center",
    emptyIconBg: "w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4",
    emptyBtn: "px-4 py-2 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded-lg text-sm font-medium transition-colors",
};
...
export const MENU_OPTIONS = [
    { action: "edit", label: "Edit Task", icon: <Edit2 size={14} className="text-indigo-600" /> },
...
export const TI_CLASSES = {
    wrapper: "group p-4 sm:p-5 rounded-xl shadow-sm bg-white border-l-4 hover:shadow-md transition-all duration-300 border border-indigo-100",
    leftContainer: "flex items-start gap-2 sm:gap-3 flex-1 min-w-0",
    completeBtn: "mt-0.5 sm:mt-1 p-1 sm:p-1.5 rounded-full hover:bg-indigo-100 transition-colors duration-300",
    ...
    subtasksContainer: "mt-3 sm:mt-4 space-y-2 sm:space-y-3 bg-indigo-50/30 p-2 sm:p-3 rounded-lg border border-indigo-100",
    ...
    menuButton: "p-1 sm:p-1.5 hover:bg-indigo-100 rounded-lg text-gray-500 hover:text-indigo-700 transition-colors duration-200",
    menuDropdown: "absolute right-0 mt-1 w-40 sm:w-48 bg-white border border-indigo-100 rounded-xl shadow-lg z-10 overflow-hidden animate-fadeIn",
